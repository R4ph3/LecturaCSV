...
def create_plots(data):
    ...
    fig = px.histogram(data, x='tipo_incidente', color='sexo', barmode='group', title='Distribución de Incidentes por Tipo y Sexo')
    fig.update_layout(xaxis_title='Tipo de Incidente', yaxis_title='Número de Incidentes')
